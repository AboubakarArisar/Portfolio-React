...
const projectsData = [
  ...
  },
  {
    ...
    description:
      "Data analysis project utilizing machine learning techniques...",
...
const Projects = () => {
  return (
    <>
      <div
        id="projects"
        className="projects-container flex flex-col flex-wrap justify-center items-center gap-8 p-8"
      >
        <h1 className="text-4xl font-semibold text-[#C58940] mb-6">Projects</h1>
        <div className="grid xsm:grid-cols-1 md:grid-cols-3 gap-8">
          {projectsData.map((project, index) => (
            ...
            >
              ...
              <div className="project-details absolute bottom-0 left-0 right-0 p-4 bg-black bg-opacity-50 text-white text-center opacity-0 transition-opacity hover:opacity-100 cursor-pointer">
                ...
                <p className="text-lg font-semibold text-[#C58940] mb-2">
                  {project.subtitle}
                </p>
